...
from .endpoints import admin, doctor_chambers, doctors_search, users, roles, doctors, patients, user_details, patient_indicators, ep_medicines, ep_chief_complaints, ep_investigations, ep_advices
