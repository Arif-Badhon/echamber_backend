...
from .doctor_workplace import DoctorWorkPlaceOut
from .doctors import DoctorOut, DoctorWithImages, DoctorWithImagesAndWorkplace
...
class UserDoctorOut(BaseModel):
    User: UserOut
    Doctor: DoctorWithImagesAndWorkplace
